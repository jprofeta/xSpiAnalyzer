...
public:
    ...
    void AdvanceSignalsToCsLeadingEdge();
    void AdvanceToNextFrame();
    void ReadBus();

    bool VerifyFrameStartOrAdvance();
    std::pair<bool, U64> IsNextClockEdgeInFrame();

    void CleanupWorkingFrame();
    void HandleFrameError( U64 frameEnd );

protected:
    enum State { Search, Start, Data, End };
